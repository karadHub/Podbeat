...
import { SearchResult, useCommandPalette } from '../useCommandPalette';
...
describe('useCommandPalette', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should load search history from localStorage on mount', () => {
      ...
      expect(localStorageMock.getItem).toHaveBeenCalledWith('podbeat_search_history');
  ...
  describe('Recent Items and Search History', () => {
    ...
    it('should clear search history', () => {
      ...
      expect(localStorageMock.removeItem).toHaveBeenCalledWith('podbeat_search_history');
      expect(result.current.recentSearches).toEqual([]);
      expect(result.current.recentItems).toEqual([]);
    });
  });
